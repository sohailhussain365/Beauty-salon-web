    ...
    <div className="absolute inset-0 overflow-hidden pointer-events-none" aria-hidden="true">
      {sparkles.map((s) => (
        <motion.div key={s.id} className="absolute rounded-full"
          style={{ left: `${s.x}%`, bottom: "-6px", width: s.size, height: s.size, background: "rgba(201,168,76,0.50)" }}
          animate={{ y: [0, -(350 + Math.random() * 200)], x: [0, (Math.random() - 0.5) * 70], opacity: [0, 0.6, 0.4, 0], scale: [0, 1, 0.7, 0] }}
    ...
    <div className="absolute inset-0 flex items-center justify-center pointer-events-none overflow-hidden" aria-hidden="true">
      {[1, 1.6, 2.3].map((scale, i) => (
        <motion.div key={i}
          ...
          style={{ width: 400, height: 400, border: "1px solid rgba(201,168,76,0.10)", borderRadius: "50%" }}
  ...
  return (
    <section id="cta" ref={ref}
      ...
      <div className="absolute inset-0"
        style={{
          background: "linear-gradient(160deg, hsl(22,20%,6%) 0%, hsl(22,18%,4%) 50%, hsl(30,15%,5%) 100%)",
        }}
        aria-hidden="true" />

      {/* Gold ambient orbs */}
      <motion.div className="absolute top-1/4 left-1/4 w-96 h-96 rounded-full pointer-events-none"
        style={{ background: "radial-gradient(ellipse, rgba(201,168,76,0.10) 0%, transparent 65%)" }}
      ...
      {/* Grid lines */}
      <div className="absolute left-0 right-0 top-1/3 h-px"
        style={{ background: "linear-gradient(90deg, transparent, rgba(201,168,76,0.06), transparent)" }} aria-hidden="true" />
      <div className="absolute left-0 right-0 bottom-1/3 h-px"
        style={{ background: "linear-gradient(90deg, transparent, rgba(201,168,76,0.05), transparent)" }} aria-hidden="true" />
        ...
        >
          ...
          <motion.div className="flex items-center gap-4"
            ...
            <motion.span className="block h-px" initial={{ width: 0 }} animate={inView ? { width: 64 } : {}}
              ...
              style={{ background: "linear-gradient(90deg, transparent, rgba(201,168,76,0.55))" }} />
            <span style={{ fontSize: 9, letterSpacing: "0.45em", textTransform: "uppercase", color: "rgba(201,168,76,0.65)" }}>Book Your Experience</span>
            <motion.span className="block h-px" initial={{ width: 0 }} animate={inView ? { width: 64 } : {}}
              transition={{ duration: 0.8, delay: 0.2 }}
              ...
              <div key={li} className="overflow-hidden">
                <motion.span className="block font-serif"
                  ...
                  style={{
                    ...
                    color: li === 0 ? "#f5ecd5" : undefined,
                  }}
                >
                  {li === 1 ? (
                    <span style={{
                      background: "linear-gradient(135deg, hsl(43,65%,52%) 0%, hsl(43,80%,66%) 40%, hsl(43,65%,52%) 100%)",
          ...
          {/* Body */}
          <motion.p style={{ fontSize: 14, color: "rgba(245,236,213,0.48)", lineHeight: 1.75, maxWidth: 480, letterSpacing: "0.02em" }}
          ...
          <motion.div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 mt-2 w-full sm:w-auto"
            ...
            <Link href="/booking" className="w-full sm:w-auto">
              <motion.div className="group relative px-10 py-5 overflow-hidden cursor-pointer w-full sm:w-auto text-center"
                ...
                style={{
                  background: "linear-gradient(135deg, hsl(43,65%,38%) 0%, hsl(43,75%,50%) 50%, hsl(43,65%,38%) 100%)",
                  boxShadow: "0 6px 32px rgba(201,168,76,0.35), 0 0 0 1px rgba(201,168,76,0.30)",
                }}
                data-testid="cta-book-btn">
                <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300"
                  style={{ background: "linear-gradient(135deg, hsl(43,75%,44%) 0%, hsl(43,80%,55%) 50%, hsl(43,75%,44%) 100%)" }} />
                <span className="relative z-10 flex items-center gap-3 font-semibold justify-center"
                  style={{ fontSize: 10, letterSpacing: "0.3em", textTransform: "uppercase", color: "hsl(22,20%,8%)" }}>
            ...
            <motion.a href="tel:+19725717787"
              className="px-8 py-5 flex items-center gap-3 transition-all duration-300 justify-center"
              style={{ fontSize: 10, letterSpacing: "0.25em", textTransform: "uppercase", color: "rgba(201,168,76,0.65)", border: "1px solid rgba(201,168,76,0.28)" }}
              whileHover={{ borderColor: "rgba(201,168,76,0.55)", color: "rgba(201,168,76,1)", y: -2, boxShadow: "0 4px 20px rgba(201,168,76,0.15)" }}
          ...
          {/* Address */}
          <motion.p style={{ fontSize: 10, color: "rgba(201,168,76,0.35)", letterSpacing: "0.2em" }}
      ...
      <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-3/4 h-px"
        style={{ background: "linear-gradient(90deg, transparent, rgba(201,168,76,0.20), transparent)" }} aria-hidden="true" />
    </section>
  );
}
