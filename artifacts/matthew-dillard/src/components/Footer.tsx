            ...
            {SOCIALS.map((s) => (
              <a
                ...
                onMouseEnter={e => {
                  ...
                  (e.currentTarget as HTMLElement).style.boxShadow = "0 6px 20px rgba(0,0,0,0.35)";
                }}
                onMouseLeave={e => {
                  (e.currentTarget as HTMLElement).style.background = "rgba(255,255,255,0.06)";
                  (e.currentTarget as HTMLElement).style.borderColor = "rgba(240,230,210,0.15)";
                  (e.currentTarget as HTMLElement).style.color = "rgba(240,230,210,0.75)";
                  (e.currentTarget as HTMLElement).style.transform = "translateY(0)";
